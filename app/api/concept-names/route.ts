...
Relevant Matrix Type: ${body.selectedDirection.rfpConceptType === 'multi_entity_pavilion' ? 'entityDifferentiationMatrix' : (body.selectedDirection.rfpConceptType === 'visitor_center_or_tour' || body.selectedDirection.rfpConceptType === 'single_brand_experience') ? 'brandExperienceMatrix' : 'none'}
