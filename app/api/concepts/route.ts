...
export async function POST(request: Request) {
  try {
    ...
    const systemPrompt = [
      ...
      'Universal Concept Novelty Guard: Nexus, Pulse, Vanguard, Synergy, Connect, Future, Innovation, Hub, Platform, Experience, Journey, Alliance, Lab, Studio, Universe, Beyond, Next, Shift, Flow는 현재 RFP 근거로 강하게 정당화되지 않으면 main conceptName으로 쓰지 말라. generic tech/event branding처럼 들리는 이름을 감점하라.',
