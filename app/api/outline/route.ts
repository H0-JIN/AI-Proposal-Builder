  ...
  try {
    ...
    const result = await createStructuredJson<{ slides: SlideOutline[] }>({
      ...
      system: [
        ...
        '사용자가 이미 선택한 콘셉트가 있으므로 Concept Candidates 비교 장표는 만들지 말고, 선택된 콘셉트를 Core Concept 장표와 Key Experience Asset Concept 장표의 기준으로 삼아라. 고정 제목 “Monument Design Concept”은 사용하지 말라.',
