...
const conceptNameOptionSchema = {
  ...
  properties: {
    ...
    validation: {
      ...
      required: ['coverReady', 'connectedToCoreWinningCondition', 'notGenericEnglishCombination', 'notInternalStrategyLabel', 'notSlideTitle', 'notTooLong', 'expandableToProposalSystem', 'specificToCurrentRfp'],
    },
